          ...
          - code [ref=e57]:
            - generic [ref=e58]:
              ...
              - generic [ref=e75]:
                ...
                - generic [ref=e79]: "[Node A] --> B[Node B]"
          - generic [ref=e82]:
            - generic [ref=e83]: Syntax Error
            - text: "Parse error on line 2: graph TD [Node A] --> B[Node ----------^ Expecting 'SEMI', 'NEWLINE', 'SPACE', 'EOF', 'subgraph', 'end', 'acc_title', 'acc_descr', 'acc_descr_multiline_value', 'AMP', 'COLON', 'STYLE', 'LINKSTYLE', 'CLASSDEF', 'CLASS', 'CLICK', 'DOWN', 'DEFAULT', 'NUM', 'COMMA', 'NODE_STRING', 'BRKT', 'MINUS', 'MULT', 'UNICODE_TEXT', 'direction_tb', 'direction_bt', 'direction_rl', 'direction_lr', 'direction_td', got 'SQS'"
      - separator [ref=e84]
      - generic [ref=e86]:
        - generic [ref=e88]:
