...
export const BASIC_SHAPES = [
  ...
  },
  {
    b: ["((", "))"],
    l: "Circle",
    i: <circle cx="12" cy="12" r="8" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    b: ["{", "}"],
    l: "Rhombus",
  ...
  },
  {
    ...
    i: (
      <path
        d="M5 7 C5 5, 19 5, 19 7 V17 C19 19, 5 19, 5 17 Z M5 7 C5 9, 19 9, 19 7"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <g>
        <circle cx="12" cy="12" r="8" stroke="currentColor" fill="none" strokeWidth="1.5" />
  ...
  },
  {
    b: [">", "]"],
    l: "Asymmetric",
    i: <path d="M4 4 h11 l5 8 l-5 8 h-11 z" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    b: ["[[", "]]"],
    l: "Subroutine",
    i: (
      <path
        d="M4 4 h16 v16 h-16 z M8 4 v16 M16 4 v16"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
...
export const EXTENDED_SHAPES = [
  ...
  },
  {
    expanded: "notch-rect",
    l: "Card",
    i: <path d="M4 4 h12 l4 4 v12 h-16 z" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    expanded: "cloud",
    l: "Cloud",
    i: (
      <path
        d="M7 17 a4 4 0 1 1 0 -8 a5 5 0 1 1 10 -2 a4.5 4.5 0 1 1 1 8.5 z"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <polygon
        points="6 4, 18 4, 12 12, 18 20, 6 20, 12 12"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M13 3 L4 14 h7 l-2 7 11 -13 h-7 z"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M15 4 Q10 4 10 12 Q10 20 15 20 M10 12 Q5 12 5 12"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M9 4 Q14 4 14 12 Q14 20 9 20 M14 12 Q19 12 19 12"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M9 4 Q4 4 4 12 Q4 20 9 20 M15 4 Q20 4 20 12 Q20 20 15 20"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M4 6 h16 M4 18 h16 M4 6 v12 M20 6 v12"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M4 6 C4 4, 20 4, 20 6 V18 C20 20, 4 20, 4 18 Z M4 6 C4 8, 20 8, 20 6"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    l: "Delay",
    i: (
      <path d="M4 4 h8 a8 8 0 0 1 0 16 h-8 z" stroke="currentColor" fill="none" strokeWidth="1.5" />
    ),
  },
  {
    expanded: "h-cyl",
    ...
    i: (
      <path
        d="M6 4 C4 4, 4 20, 6 20 H18 C20 20, 20 4, 18 4 Z M6 4 C8 4, 8 20, 6 20"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M4 6 C4 4, 20 4, 20 6 V18 C20 20, 4 20, 4 18 Z M4 6 C4 8, 20 8, 20 6 M4 10 h16 M4 14 h16"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M4 12 C4 4, 8 4, 8 4 H20 V20 H8 C8 20, 4 20, 4 12 Z"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M4 4 h16 v12 c-4 -4, -8 4, -16 0 z"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    expanded: "tri",
    l: "Extract",
    i: <polygon points="12 4, 20 20, 4 20" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    expanded: "fork",
    l: "Fork/Join",
    i: <rect x="4" y="10" width="16" height="4" fill="currentColor" />,
  },
  {
    expanded: "win-pane",
    l: "Internal Storage",
  ...
  { expanded: "f-circ", l: "Junction", i: <circle cx="12" cy="12" r="8" fill="currentColor" /> },
  {
    ...
    i: (
      <path
        d="M4 4 h16 v12 c-4 -4, -8 4, -16 0 z M4 8 h16 M4 12 h16"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <polygon
        points="4 10, 12 4, 20 10, 20 20, 4 20"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    expanded: "flip-tri",
    l: "Manual File",
    i: <polygon points="4 4, 20 4, 12 20" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    expanded: "sl-rect",
    l: "Manual Input",
  ...
  },
  {
    ...
    i: (
      <path
        d="M8 8 h12 v10 c-3 -3, -6 3, -12 0 z M6 6 h12 v10 M4 4 h12 v10"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    ...
    i: (
      <path
        d="M4 4 q 4 -2, 8 0 t 8 0 v12 q -4 2, -8 0 t -8 0 z"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
  ...
  },
  {
    expanded: "circle",
    l: "Start",
    i: <circle cx="12" cy="12" r="9" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    expanded: "sm-circ",
    l: "Start (Small)",
    i: <circle cx="12" cy="12" r="5" stroke="currentColor" fill="none" strokeWidth="1.5" />,
  },
  {
    expanded: "dbl-circ",
    l: "Stop",
    i: (
      <g>
        <circle cx="12" cy="12" r="9" stroke="currentColor" fill="none" strokeWidth="1.5" />
        <circle cx="12" cy="12" r="6" stroke="currentColor" fill="none" strokeWidth="1.5" />
      </g>
    ),
  },
  {
    ...
    i: (
      <g>
        <circle cx="12" cy="12" r="9" stroke="currentColor" fill="none" strokeWidth="1.5" />
        <circle cx="12" cy="12" r="7.5" stroke="currentColor" fill="none" strokeWidth="0.5" />
      </g>
    ),
  },
  {
    ...
    i: (
      <path
        d="M6 4 h12 a4 12 0 0 0 0 16 h-12 a4 12 0 0 1 0 -16 z"
        stroke="currentColor"
        fill="none"
        strokeWidth="1.5"
      />
    ...
    i: (
      <g>
        <path
          ...
          strokeWidth="1.5"
        />
        <path d="M4 4 l6 6 v4" stroke="currentColor" fill="none" strokeWidth="1.5" />
      </g>
    ),
  },
  {
    ...
    i: (
      <g>
        <rect
          ...
          strokeWidth="1.5"
        />
        <polygon points="4 4, 12 4, 12 12" stroke="currentColor" fill="none" strokeWidth="1.5" />
      </g>
    ),
  },
  {
...
const FlowchartToolbar = ({ code, setCode, selectedNodeId }: EditorContext) => {
  ...
  const handleAddShape = (shape: ShapeOption) => {
    ...
    if (selectedNodeId) {
      if (shape.expanded || shape.isText) {
  ...
  const handleAddSubgraph = () => {
    const subId = getNextNodeId(code, "sub");
    const nodeId = getNextNodeId(code, "n");
    const newCode =
      code +
  ...
  return (
    <>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          render={
            <Button
              variant="ghost"
              size="sm"
              className="h-8 text-foreground hover:bg-accent hover:text-accent-foreground flex items-center gap-1.5 px-2.5 rounded-lg"
        ...
        <DropdownMenuContent
          className="w-48 p-2 bg-background border border-border rounded-xl flex flex-col gap-1"
          sideOffset={10}
          align="start"
        >
          <div className="flex flex-col">
      ...
      <div className="flex items-center gap-2 rounded-xl bg-background p-0 border-none">
        <DropdownMenu>
          ...
          <DropdownMenuContent
            className="w-[340px] max-h-[60vh] overflow-y-auto p-4 bg-background border-border rounded-xl flex flex-col gap-6"
            sideOffset={10}
            align="start"
          >
            {/* Basic Shapes */}
