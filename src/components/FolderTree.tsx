    ...
    return (
        <div>
            <div
                ...
                className={`group flex items-center gap-1.5 rounded-md py-1.5 pr-2 text-sm cursor-pointer transition-colors ${isActive ? 'bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 font-medium' : 'text-foreground/80 hover:bg-accent hover:text-foreground'
            ...
            >
                ...
                {isActive ? <FolderOpen className="h-4 w-4 shrink-0" /> : <FolderIcon className="h-4 w-4 shrink-0" />}
    ...
    return (
        <div className="flex flex-col gap-0.5">
            ...
            <div
                ...
                className={`flex items-center gap-1.5 rounded-md py-1.5 pl-2 pr-2 text-sm cursor-pointer transition-colors ${currentFolderId === null ? 'bg-indigo-500/15 text-indigo-700 dark:text-indigo-300 font-medium' : 'text-foreground/80 hover:bg-accent hover:text-foreground'
