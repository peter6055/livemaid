                ...
                {PRESET_COLORS.map((c) => {
                    ...
                    return (
                        <button
                            ...
                            className={`relative h-6 w-6 rounded-md border transition-transform hover:scale-110 ${isActive ? "border-indigo-500 ring-2 ring-indigo-500/40" : "border-border"
        ...
        >
            <div className="flex w-max items-center gap-1 rounded-xl border border-border bg-background px-1.5 py-1 shadow-lg">
                ...
                <div className="relative">
                    <button
                        type="button"
                        className={`pointer-events-auto flex h-8 items-center justify-center gap-1.5 rounded-md px-2.5 text-sm font-semibold transition-colors ${styleOpen
                                ...
                                <div className="grid grid-cols-2 gap-1">
                                    {BORDER_STYLES.map((b) => (
                                        <button
                                            ...
                                            className={`flex items-center justify-between gap-2 rounded-md border px-2 py-1.5 text-left text-sm font-medium transition-colors ${activeBorderStyle === b.id
