      ...
      <div className="flex items-center gap-0.5 bg-background border border-border rounded-xl px-1.5 py-1 shadow-lg text-foreground">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger
            render={
              <button
                className="h-8 px-2.5 flex items-center justify-center rounded-md hover:bg-accent hover:text-accent-foreground transition-colors relative gap-1 text-sm font-semibold"
                title="Arrow Style"
              />
            }
          >
          ...
          <DropdownMenuContent
            className="p-1 bg-background border border-border rounded-xl min-w-56 flex flex-col gap-0.5"
            align="center"
            side="top"
            sideOffset={10}
          >
            {ARROW_TYPES.map((type) => (
              ...
              >
                <span className="w-12 shrink-0 text-center font-mono text-base tracking-tighter text-indigo-500">
                  {type.preview}
                </span>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            className="p-1 bg-background border border-border rounded-xl min-w-52 flex flex-col gap-0.5"
            align="center"
            side="top"
            sideOffset={10}
          >
