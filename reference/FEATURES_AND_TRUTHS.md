...
- **Sequence Note Actions in Floating Toolbar**: Selecting a sequence actor or message shows a Note dropdown in `SequenceManipulationToolbar` with `Add note to the left/right/over`. Selecting a sequence note shows note-specific controls: `Change position` (left/right/over), `Link/Connect` placeholder action, and `Delete`. All add/move actions mutate Mermaid DSL immediately and re-render via the normal `handleCodeChange` path.
...
- **Sequence Note Dialog Modal**: Clicking the Note button in the toolbar opens a modal dialog titled "Add Note" with three button options for position selection: "Note to the left", "Note to the right", and "Note over". The selected button is highlighted with default styling. Clicking "Add Note" confirms the selection and closes the dialog, or "Cancel" dismisses without adding. The dialog defaults to "Note to the right" position on each open.
- **Sequence Note Actions in Floating Toolbar**: Selecting a sequence actor or message shows a Note button in `SequenceManipulationToolbar`. Clicking the Note button opens the Add Note dialog (see above). Selecting a sequence note shows note-specific controls: `Change position` (left/right/over), `Link/Connect` placeholder action, and `Delete`. All add/move actions mutate Mermaid DSL immediately and re-render via the normal `handleCodeChange` path.
- **Sequence Note Actions in Floating Toolbar**: Selecting a sequence actor or message shows a Note button in `SequenceManipulationToolbar`. Clicking the Note button opens the Add Note dialog (see above). Selecting a sequence note shows note-specific controls: `Change position` (left/right/over), `Link/Connect` placeholder action, and `Delete`. All add/move actions mutate Mermaid DSL immediately and re-render via the normal `handleCodeChange` path.
- **Sequence Note Dialog Modal**: Clicking the Note button in the toolbar opens a modal dialog titled "Add Note" with three button options for position selection: "Note to the left", "Note to the right", and "Note over". The selected button is highlighted with default styling. Clicking "Add Note" confirms the selection and closes the dialog, or "Cancel" dismisses without adding. The dialog defaults to "Note to the right" position on each open.
- **Sequence Note Actions in Floating Toolbar**: Selecting a sequence actor or message shows a Note button in `SequenceManipulationToolbar`. Clicking the Note button opens the Add Note dialog. Selecting a sequence note shows note-specific controls: `Change position` (left/right/over), `Link/Connect` placeholder action, and `Delete`. All add/move actions mutate Mermaid DSL immediately and re-render via the normal `handleCodeChange` path.
