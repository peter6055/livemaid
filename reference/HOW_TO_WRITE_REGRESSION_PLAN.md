...
While Test-Driven Development (TDD) and Behavior-Driven Development (BDD) are methodologies for creating tests *during* the development of a feature, Regression Testing is the methodology for ensuring *past* features continue to work. 
...
- **Regression Scenarios (BDD):** The specific Given/When/Then scenarios from the *original* feature's testplan that must be re-run.
